...
/* =========================================================
   VYOMA SETTINGS: VOICE ASSISTANCE + SIGN OUT
========================================================= */
(function initVyomaSettingsVoiceAndSignOut(){
  ...
  const settingsToggle = document.getElementById("settingsVoiceToggle");
  const guidanceToggle = document.getElementById("voiceGuidanceToggle");
  const signOutBtn = document.getElementById("signOutBtn");

  function voiceIsOn(){
    if (settingsToggle) return settingsToggle.checked === true;
    return !!(guidanceToggle && guidanceToggle.checked);
  }
  ...
  function syncVoiceToggles(value){
    if (settingsToggle) settingsToggle.checked = value;
    if (guidanceToggle) guidanceToggle.checked = value;
    if (!value) stopAllSpeech();
    window.vyomaVoiceEnabled = value;
  }

  if (settingsToggle) {
    settingsToggle.checked = false;
    settingsToggle.addEventListener("change", () => {
      syncVoiceToggles(settingsToggle.checked);
    });
  }

  if (guidanceToggle) {
    guidanceToggle.addEventListener("change", () => {
      syncVoiceToggles(guidanceToggle.checked);
    });
  }

  window.vyomaVoiceIsOn = voiceIsOn;
