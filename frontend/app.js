...
(function () {
 ...
 set("vyomaExtendedNote", "Stationary IMU baseline saved. Keep the phone mounted consistently; this is a baseline calibration, not a full vehicle-frame alignment proof recordEvent("calibration", state.calibration);
 }
