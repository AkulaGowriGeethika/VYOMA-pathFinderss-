...
(function () {
 ...
 const text = `VYOMA status. Road condition ${state.roadCondition}. Vibration score ${state.vibrationScore.toFixed(2)}. ${navigator.onLine ? "Online" : "Offline"}.`;
