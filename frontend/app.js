...
if(typeof firebase === "undefined" || !window.VYOMA_FIREBASE_CONFIG || !window.VYOMA_FIREBASE_CONFIG.apiKey ||
...
if (note) {
note.textContent =
"This measures browser loop throughput only. It does not prove 10 Hz sensor navigation accuracy or 200 Hz external-IMU hardware
performance.";
}
};
...
set("vyomaExtendedNote", "Stationary IMU baseline saved. Keep the phone mounted consistently; this is a baseline calibration, not a
full vehicle-frame alignment proof.");
